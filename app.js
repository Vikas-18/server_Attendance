...
app.post("/markAttendance", async (req, res) => {
  ...
  const classroomLatitude = 21.2129; // Replace with the actual latitude of the classroom
  const classroomLongitude = 81.4293; // Replace with the actual longitude of the classroom
